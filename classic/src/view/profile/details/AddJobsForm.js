/**
 * The file AddJobsForm is the form view of the add jobs button in the user profile.
 * @extends {Ext.form.Panel}.
 * @alias 'widget.addjobsform'.
 * @model : DDO.view.jobs.AddJobsFormModel.
 * @controller : DDO.view.jobs.AddJobsFormController.
 */
Ext.define('DDO.view.profile.details.AddJobsForm', {
    ...
    requires: [
        'DDO.view.jobs.AddJobsFormModel',
        'DDO.view.jobs.AddJobsFormController'
    ],

    controller: 'addjobsformcontroller',
    viewModel: {
        type: 'addjobsformmodel'
    },
    ...
    items: [{
        ...
        boxLabel: LabelsTitles.PROFILE.ADDJOB.CURRENTWORK,
        labelWidth: 150,
